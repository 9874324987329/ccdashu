...
FileUtils {
    ...
    public static void writeIntoFile(File file, String content, boolean append) throws Exception {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            try{
                writeIntoFile(new File("/Users/ccdashu/Downloads/comments.txt"), i + ";", true);
            }catch(Exception e){
                e.printStackTrace();
            }
